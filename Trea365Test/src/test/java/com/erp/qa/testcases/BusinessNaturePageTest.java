...
public class BusinessNaturePageTest extends TestBase  {
	...
	public void VerifyBusinessPageTitle() {
		String BusinessPageTitle= driver.getTitle();
		System.out.println("title=" +BusinessPageTitle);
		Assert.assertEquals(BusinessPageTitle, "Nature of Business" );
	}
	...
	@Test(priority=5,dataProvider="getTreaTestData")
